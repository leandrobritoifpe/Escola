...
if (isset($_GET['dataInicial'])){
    ...
    $descricao;
    $nome;
    $query = mysql_query("select descricao from esc_cad_disciplina where codigo = '$disciplina'");
    while ($row1 = mysql_fetch_array($query)) {
        $descricao = $row1['descricao'];
    }
    $query2 = mysql_query("select nome from usuarios where codigo = '$professor'");
...
<div align="center">
	...
	<br>
        <div align="center">
            <table border="1">
                <tr>
                    <th>DISCIPLINA CONSULTADA &nbsp;</th>
                    <th> &nbsp; 
                        <?php echo $descricao?>
                    </th>
                </tr>
                <tr>
                    <th>PROFESSOR CONSULTADO &nbsp;</th>
                    <th> &nbsp; 
                        <?php echo $nome?>
                    </th>
                </tr>
